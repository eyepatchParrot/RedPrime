...
if(!isObject(GuiDefaultProfile)) new GuiControlProfile (GuiDefaultProfile)
{
	...
	// bitmap information
    bitmap = "^SearchTest/gui/images/window.png";
    bitmapBase = "";
    textOffset = "0 0";
...
if(!isObject(GuiScrollProfile)) new GuiControlProfile (GuiScrollProfile)
{
    ...
    border = 1;
    borderThickness = 2;
    bitmap = "modules/SearchTest/1/gui/images/scrollBar.png";
    hasBitmapArray = true;
};
...
if (!isObject(GuiTextEditProfile)) new GuiControlProfile (GuiTextEditProfile)
{
    ...
    border = -2;
    bitmap = "modules/SearchTest/1/gui/images/textEdit.png";
...
if (!isObject(GuiButtonProfile)) new GuiControlProfile (GuiButtonProfile)
{
    ...
    canKeyFocus = false;
    fontType = $platformFontType;
    bitmap = "modules/SearchTest/1/gui/images/smallButtonContainer";
...
if (!isObject(BlueButtonProfile)) new GuiControlProfile (BlueButtonProfile : GuiButtonProfile)
{
    ...
    bitmap = "modules/SearchTest/1/gui/images/blueButton.png";
};
